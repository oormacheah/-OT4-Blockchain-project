...
import { HomeRoute, NewPaperRoute, SearchRoute, SearchResultsRoute } from './components/routes';

const fakePapers = [
  {id: 0, title: 'Blockchain', author: 'Nawid', keywords: ['blockchain', 'research'], file: '0x414', owner: 1, value: 200},
  {id: 1, title: 'MLPR', author: 'Omar', keywords: ['machine-learning', 'models', 'plots'], file: '0x814', owner: 2, value: 100},
  {id: 2, title: 'MLDA', author: 'Alfredo', keywords: ['el-papu', 'machine-learning'], file: '0x1111', owner: 3, value: 122},
  {id: 3, title: 'PSAT project', author: 'Felipe', keywords: ['scientific', 'paper'], file: '0x3224', owner: 4, value: 67},
]
...
function App() {
  ...
  const [user, setUser] = useState(0); // Should be an address
    ...
    <Container className="App" fluid>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/search/results" element={<SearchResultsRoute papers={papers}/>}/>
        </Routes>
      </BrowserRouter>
    </Container>
  );
